<div <?php wc_product_class( $item_classes ); ?>>
    <div class="qodef-woo-product-inner">
		<?php if ( has_post_thumbnail() ) { ?>
            <div class="qodef-woo-product-image">
                ...
                <div class="qodef-woo-product-image-inner">
					<?php
					alloggio_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/add-to-cart' );
        ...
        <div class="qodef-woo-product-content">
			...
			do_action( 'alloggio_core_action_product_list_item_additional_content' );
			?>
        </div>
