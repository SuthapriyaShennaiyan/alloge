...
if ( ! class_exists( 'AlloggioCoreCheckoutIntegration' ) ) {
	class AlloggioCoreCheckoutIntegration {
		...
		function include_files() {
			include_once ALLOGGIO_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-product-qodef.php';
			include_once ALLOGGIO_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-qodef-data-store-cpt.php';
			include_once ALLOGGIO_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-order-item-qodef.php';
			include_once ALLOGGIO_CORE_PLUGINS_PATH . '/checkout/payment/class-wc-order-item-qodef-data-store.php';
		}
		...
		public function supported_post_types() {
			return apply_filters( 'alloggio_core_filter_checkout_integration_post_types', array() );
		}
		...
		public function data_store_integration( $data_stores ) {
			...
			if ( ! empty( $supported_types ) ) {
				foreach ( $supported_types as $supported_type ) {
					$custom_data_stores[ 'product-' . $supported_type ]    = 'WC_' . $this->transform_class_name( $supported_type ) . '_Data_Store_CPT';
	...
	AlloggioCoreCheckoutIntegration::get_instance();
}