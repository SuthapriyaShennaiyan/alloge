...
if ( ! class_exists( 'AlloggioCoreRootMainMenuWalker' ) ) {
	class AlloggioCoreRootMainMenuWalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			if ( $depth == 0 ) {
				...
				$inner_classes = apply_filters( 'alloggio_core_filter_drop_down_second_inner_classes', array( 'qodef-drop-down-second-inner' ) );
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$anchor_link      = alloggio_core_get_option_value( 'nav-menu', 'qodef-enable-anchor-link', '', $item->ID );
			$menu_appearance  = alloggio_core_get_option_value( 'nav-menu', 'qodef-menu-item-appearance', '', $item->ID );
			$mega_menu_widget = alloggio_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-widget', '', $item->ID );
			$menu_icon_pack   = alloggio_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack', '', $item->ID );
			$menu_icon        = alloggio_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack-icon', '', $item->ID );
