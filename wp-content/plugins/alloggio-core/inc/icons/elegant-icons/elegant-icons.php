...
if ( ! function_exists( 'alloggio_core_add_elegant_icons_to_collection' ) ) {
	function alloggio_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'AlloggioCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'alloggio_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class AlloggioCoreElegantIconsPack extends QodeFrameworkIconPack {
