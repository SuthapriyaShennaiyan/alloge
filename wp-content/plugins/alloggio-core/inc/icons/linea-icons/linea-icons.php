...
if ( ! function_exists( 'alloggio_core_add_linea_icons_to_collection' ) ) {
	function alloggio_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'AlloggioCoreLineaIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'alloggio_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class AlloggioCoreLineaIconsPack extends QodeFrameworkIconPack {
