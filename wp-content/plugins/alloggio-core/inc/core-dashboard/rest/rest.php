...
if ( ! class_exists( 'AlloggioCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class AlloggioCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'alloggio_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	AlloggioCoreDashboardRestAPI::get_instance();
}