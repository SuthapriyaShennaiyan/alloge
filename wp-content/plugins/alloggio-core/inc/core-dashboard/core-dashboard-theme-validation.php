...
if ( class_exists( 'AlloggioCoreDashboardRestAPI' ) ) {
	class AlloggioCoreDashboardThemeValidation extends AlloggioCoreDashboardRestAPI {
		...
		/**
		 * @return AlloggioCoreDashboardRestAPI|AlloggioCoreDashboardThemeValidation
		 */
		...
		public function register_rest_api_route() {
			register_rest_route(
				...
				array(
					...
					'callback'            => array( AlloggioCoreDashboard::get_instance(), 'theme_validation' ),
	...
	AlloggioCoreDashboardThemeValidation::get_instance();
}