<?php
$styles = array();
if ( ! empty( $simple_item_bottom_margin ) ) {
	$margin_bottom = qode_framework_string_ends_with_space_units( $simple_item_bottom_margin ) ? $simple_item_bottom_margin : intval( $simple_item_bottom_margin ) . 'px';
