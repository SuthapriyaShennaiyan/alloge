...
if ( ! function_exists( 'alloggio_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function alloggio_get_filter_items( $params ) {
		...
		return apply_filters( 'alloggio_filter_get_filter_items', $items, $params );
	}
}