...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'alloggio' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'alloggio' );
...
<div class="qodef-quantity-buttons quantity">
	...
	<input
		type="<?php echo esc_attr( apply_filters( 'alloggio_filter_woo_quantity_input_type', 'text' ) ); ?>"
		<?php echo esc_attr( $is_readonly ) ? 'readonly="readonly"' : ''; ?>
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'alloggio' ); ?>"
			size="4"
